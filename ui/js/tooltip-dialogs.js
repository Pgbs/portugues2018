...
var TooltipDialogs = (function() {
  ...
  var dialogBoxes = [{
    ...
    text: 'Bem-Vindo!  \n\n'
      + ' Aqui você pode tirar dúvidas relacionadas aos conteúdos programático do 1º ano do ensino médio.',
    // id of an element to display while this dialog box is active
    showId: null
  }, {
    dialogId: 'type-here-tooltip-dialog',
    text: 'Você pode fazer suas perguntas aqui.',
    showId: 'input-wrapper'
  } //,
  
  //{
  //  dialogId: 'menu-here-tooltip-dialog',
  //  text: 'E se você não souber o que perguntar, temos alguns exemplos aqui.',
  //  showId: 'help'
 // }
      ...
      var listItemJson = {
        ...
        'children': [{
          ...
          'children': [{
            ...
            'text': ((i <= dialogBoxes.length) ? 'Próximo' : 'Concluir')
          }]
        }]
      };
